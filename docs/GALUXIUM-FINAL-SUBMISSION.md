...
| Verifiable Infrastructure | Security-reviewed submission source (GRAFT source plus the compiled vendored verification kernel), professional README, architecture, dependencies, supported shapes, and reproduction steps | https://github.com/Ledgercorp/GRAFT-Galuxium | READY | **Code repository** | Deliberately sanitized publication mirror; provenance is explained below. |
